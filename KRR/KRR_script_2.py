...
if method=='linear':
    ...
    with open(folder + "2_lin_train", 'wb') as file:
        pickle.dump([lam_list, c_list, out1_matrix_lin], file)
    with open(folder + "2_lin_val", 'wb') as file:
...
if method=='polynomial':
    ...
    with open(folder + "2_pol_train", 'wb') as file:
        pickle.dump([lam_list, c1_list, c2_list, d_list, out1_matrix_pol], file)
    with open(folder + "2_pol_val", 'wb') as file:
...
if method=='gaussian':
    ...
    with open(folder + "2_gauss_train", 'wb') as file:
        pickle.dump([lam_list, sigma_list, out1_matrix_gauss], file)
    with open(folder + "2_gauss_val", 'wb') as file:
...
if method=='laplacian':
    ...
    with open(folder + "2_laplace_train", 'wb') as file:
        pickle.dump([lam_list, sigma_list, out1_matrix_laplace], file)
    with open(folder + "2_laplace_val", 'wb') as file:
