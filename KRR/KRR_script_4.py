...
if method=='linear':
    ...
    with open(folder + "4_lin_train_"+str(lambd), 'wb') as file:
        pickle.dump([lambd, c_list, out1_matrix_lin], file)
    with open(folder + "4_lin_val_"+str(lambd), 'wb') as file:
...
if method=='polynomial':
    ...
    with open(folder + "4_pol_train", 'wb') as file:
        pickle.dump([lam_list, c1_list, c2_list, d_list, out1_matrix_pol], file)
    with open(folder + "4_pol_val", 'wb') as file:
...
if method=='gaussian':
    ...
    with open(folder + "4_gauss_train_"+str(lambd), 'wb') as file:
        pickle.dump([lambd, sigma_list, out1_matrix_gauss], file)
    with open(folder + "4_gauss_val_"+str(lambd), 'wb') as file:
...
if method=='laplacian':
    ...
    with open(folder + "4_laplace_train_"+str(lambd), 'wb') as file:
        pickle.dump([lambd, sigma_list, out1_matrix_laplace], file)
    with open(folder + "4_laplace_val_"+str(lambd), 'wb') as file:
