...
if method=='linear':
    ...
    with open(folder + "2_faulty_lin_train", 'wb') as file:
        pickle.dump([lam_list, c_list, out1_matrix_lin], file)
    with open(folder + "2_faulty_lin_val", 'wb') as file:
...
c1_list = list(frange(-5,20,2.5))

c2_list = list(frange(-20,25,5))


d_list = list(frange(-20,25,5))
...
if method=='polynomial':
    ...
    with open(folder + "2_faulty_pol_train", 'wb') as file:
        pickle.dump([lam_list, c1_list, c2_list, d_list, out1_matrix_pol], file)
    with open(folder + "2_faulty_pol_val", 'wb') as file:
...
sigma_list = [-1,-0.5,0.5,1,1.5,2,5]
...
if method=='gaussian':
    ...
    with open(folder + "2_faulty_gauss_train", 'wb') as file:
        pickle.dump([lam_list, sigma_list, out1_matrix_gauss], file)
    with open(folder + "2_faulty_gauss_val", 'wb') as file:
...
if method=='laplacian':
    ...
    with open(folder + "2_faulty_laplace_train", 'wb') as file:
        pickle.dump([lam_list, sigma_list, out1_matrix_laplace], file)
    with open(folder + "2_faulty_laplace_val", 'wb') as file:
