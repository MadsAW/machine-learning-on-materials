c_list = [[5],[10],[100]]
for prdf in ["compare"]:#"default", "faulty", "newest","deep"
    for description in ["GP","SimpleLarge"]:#"GP","SimpleLarge"
        for ktype in ["linear","gaussian","laplacian"]:#,"linear","gaussian","laplacian"
            for lambd in [0.000001,0.001, 1]:#0.01, 0.001, 0.1, 10, 1
                for c1 in c_list:
