...
if method=='linear':
    ...
    with open(folder + "3_faulty_lin_train", 'wb') as file:
        pickle.dump([lam_list, c_list, out1_matrix_lin], file)
    with open(folder + "3_faulty_lin_val", 'wb') as file:
...
if method=='gaussian':
    ...
    with open(folder + "3_faulty_gauss_train", 'wb') as file:
        pickle.dump([lam_list, sigma_list, out1_matrix_gauss], file)
    with open(folder + "3_faulty_gauss_val", 'wb') as file:
...
if method=='laplacian':
    ...
    with open(folder + "3_faulty_laplace_train", 'wb') as file:
        pickle.dump([lam_list, sigma_list, out1_matrix_laplace], file)
    with open(folder + "3_faulty_laplace_val", 'wb') as file:
