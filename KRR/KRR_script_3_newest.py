...
lam_list = [10**n for n in range(-5,1)]

c_list = [10**n for n in range(-4,8)]
x = [-10**n for n in range(-4,7)]
x.reverse()
c_list = x + c_list
...
if method=='linear':
    ...
    with open(folder + "3_newest_lin_train", 'wb') as file:
        pickle.dump([lam_list, c_list, out1_matrix_lin], file)
    with open(folder + "3_newest_lin_val", 'wb') as file:
...
lam_list = [10**n for n in range(-3,2)]
...
if method=='polynomial':
    ...
    with open(folder + "3_newest_pol_train", 'wb') as file:
        pickle.dump([lam_list, c1_list, c2_list, d_list, out1_matrix_pol], file)
    with open(folder + "3_newest_pol_val", 'wb') as file:
...
lam_list = [10**n for n in range(-3,-1)]

sigma_list = [0.25,0.4,0.5,0.6,0.7]
...
if method=='gaussian':
    ...
    with open(folder + "3_newest_gauss_train", 'wb') as file:
        pickle.dump([lam_list, sigma_list, out1_matrix_gauss], file)
    with open(folder + "3_newest_gauss_val", 'wb') as file:
...
if method=='laplacian':
    ...
    with open(folder + "3_newest_laplace_train", 'wb') as file:
        pickle.dump([lam_list, sigma_list, out1_matrix_laplace], file)
    with open(folder + "3_newest_laplace_val", 'wb') as file:
