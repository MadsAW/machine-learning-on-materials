...
if method=='linear':
    ...
    with open(folder + "out_matrix_lin_new_prdf", 'wb') as file:
...
if method=='polynomial':
    ...
    with open(folder + "out_matrix_pol_new_prdf", 'wb') as file:
...
if method=='gaussian':
    ...
    with open(folder + "out_matrix_gauss_new_prdf", 'wb') as file:
...
if method=='laplacian':
    ...
    with open(folder + "out_matrix_laplace_new_prdf", 'wb') as file:
