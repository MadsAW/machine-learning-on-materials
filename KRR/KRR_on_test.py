...
featureMatrixFileValidate = "test_featureMatrix.npy"
atomicSymbolsListFileValidate = "test_pickledAtomicSymbolsList.txt"
energiesFileValidate = "test_pickledEnergies.txt"
if Feature=="SimpleLarge":
