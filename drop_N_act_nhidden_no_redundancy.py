...
import os
from createLargerFeatureMatrix import no_redundancy_matrix
import pickle
...
largeFeatureMatrix = no_redundancy_matrix(path,featureMatrixFile, atomicSymbolsListFile)
...
largeFeatureMatrixValidate = largeFeatureMatrix = no_redundancy_matrix(path,featureMatrixFileValidate, atomicSymbolsListFileValidate)
